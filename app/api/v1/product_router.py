...
from app.crud import product_crud, category_crud # Necesitamos category_crud para verificar category_id
# from app.db import models # Para autenticación después
# from app.api import deps # Para autenticación después
...
def create_product_endpoint(
    ...
    # Verificar si la categoría existe (si se proporciona category_id)
...
def update_product_endpoint(
    ...
    # Verificar si la nueva categoría existe (si se proporciona category_id en la actualización)
    ...
    # Verificar si el nuevo SKU (si se proporciona) ya está en uso por OTRO producto
...
@router.delete(
    ...
    status_code=status.HTTP_200_OK, # O HTTP_204_NO_CONTENT
